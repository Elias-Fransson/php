...
<html>
	<head>
		<meta charset="UTF-8">
		<h1>Spela lite KENO och VINN!</h1>
	...
	<body>
		<form method="POST">
			...
			<input type="submit" name="Skicka!" size="25">
		</form>
	</body>
</html>
...
if (isset($_POST['minaTal'])) {
	...
	if (count($minaTal)!==11) { // Det är inte 11 tal i arrayen
		...
		for($i=0;$i<11;$i++) { // Kolla att det är ett heltal mellan 1 och 70
	...
	if($ok) {
		...
		// Skriv ut talen
		echo "<br>De 20 slumpade talen är...<br>";
